<?php 
	define('HOST','http://localhost/marketing/');
	define('SERVER',$_SERVER['DOCUMENT_ROOT'].'/marketing/');
	...
	// Nombres Principales
	define('NOMBRE_APP','Marketing Digital');
	define('NOMBRE_MUNICIPIO','Pasto');
	define('NOMBRE_CABECERA','Nariño');
