<?php 
include_once $_SERVER['DOCUMENT_ROOT']."/marketing/application/settings.php";

$estilos = ['estilos_inicio.css','comp_accordion.css','comp_modal.css'];
...
<?php
$scripts = ['comp_accordion.js','comp_modal.js'];
